...
def main():
    ...
    parser.add_argument('data_directory', help='Path to directory containing ASSESS CSV files')
    parser.add_argument('mapping_file', help='Path to JSONata mapping file (default: assess.jsonata)', 
                        default='mapping/assess.jsonata', nargs='?')
